      ...
      <div className="main__description flex justify-center">
        <div className="lg:w-[60vw] w-[100%]">
          <div className="flex justify-end mb-8">
            ...
            >
              <PlusOutlined className="mt-1" /> <p>Add Profile</p>
            </button>
          </div>
          <div className="box ">
            ...
            <ul className="uiList mt-[40px]">
              ...
              <li className="flex justify-between align-baseline">
                ...
                <div className="flex justify-between">
                  <button className=" flex align-baseline gap-3 hover:text-blue-700 text-gray-800 font-medium rounded-lg text-md px-5 py-2.5 text-center">
                    <EditOutlined />
                  </button>
                  <button className=" flex align-baseline gap-3 hover:text-red-700 text-gray-800 font-medium rounded-lg text-md px-5 py-2.5 text-center">
                    <DeleteOutlined />
                  </button>
                </div>
              </li>
